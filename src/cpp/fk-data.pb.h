...
inline const std::string& Firmware::_internal_git() const {
  return git_.GetNoArena();
}
inline void Firmware::_internal_set_git(const std::string& value) {
...
inline std::string* Firmware::_internal_mutable_git() {
