...
/* Generated by nanopb-0.3.9-dev at Thu Apr 19 10:52:44 2018. */
...
const pb_field_t fk_data_DataRecord_fields[5] = {
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(fk_data_LoggedReading, location) < 65536 && pb_membersize(fk_data_LoggedReading, reading) < 65536 && pb_membersize(fk_data_DataRecord, loggedReading) < 65536 && pb_membersize(fk_data_DataRecord, metadata) < 65536 && pb_membersize(fk_data_DataRecord, log) < 65536 && pb_membersize(fk_data_DataRecord, status) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_fk_data_DeviceLocation_fk_data_SensorReading_fk_data_LoggedReading_fk_data_ModuleInfo_fk_data_SensorInfo_fk_data_Metadata_fk_data_Status_fk_data_LogMessage_fk_data_DataRecord)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(fk_data_LoggedReading, location) < 256 && pb_membersize(fk_data_LoggedReading, reading) < 256 && pb_membersize(fk_data_DataRecord, loggedReading) < 256 && pb_membersize(fk_data_DataRecord, metadata) < 256 && pb_membersize(fk_data_DataRecord, log) < 256 && pb_membersize(fk_data_DataRecord, status) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_fk_data_DeviceLocation_fk_data_SensorReading_fk_data_LoggedReading_fk_data_ModuleInfo_fk_data_SensorInfo_fk_data_Metadata_fk_data_Status_fk_data_LogMessage_fk_data_DataRecord)
#endif
