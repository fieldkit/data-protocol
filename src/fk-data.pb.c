...
const pb_field_t fk_data_ModuleInfo_fields[3] = {
    PB_FIELD(  1, UINT32  , SINGULAR, STATIC  , FIRST, fk_data_ModuleInfo, id, id, 0),
    PB_FIELD(  2, STRING  , SINGULAR, CALLBACK, OTHER, fk_data_ModuleInfo, name, id, 0),
    PB_LAST_FIELD
};
