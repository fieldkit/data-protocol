...
/* Generated by nanopb-0.3.9-dev at Fri Mar  2 11:35:58 2018. */
...
#define fk_data_ModuleInfo_init_default          {0, {{NULL}, NULL}}
#define fk_data_SensorInfo_init_default          {0, {{NULL}, NULL}, {{NULL}, NULL}}
#define fk_data_Metadata_init_default            {{{NULL}, NULL}, 0, {{NULL}, NULL}, 0, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define fk_data_ModuleInfo_init_zero             {0, {{NULL}, NULL}}
#define fk_data_SensorInfo_init_zero             {0, {{NULL}, NULL}, {{NULL}, NULL}}
#define fk_data_Metadata_init_zero               {{{NULL}, NULL}, 0, {{NULL}, NULL}, 0, {{NULL}, NULL}, {{NULL}, NULL}}
#define fk_data_DataRecord_init_zero             {fk_data_LoggedReading_init_zero, fk_data_Metadata_init_zero}
...
#define fk_data_ModuleInfo_name_tag              2
...
extern const pb_field_t fk_data_ModuleInfo_fields[3];
extern const pb_field_t fk_data_SensorInfo_fields[4];
extern const pb_field_t fk_data_Metadata_fields[7];
extern const pb_field_t fk_data_DataRecord_fields[3];
...
#define fk_data_DataRecord_size                  (78 + fk_data_Metadata_size)
